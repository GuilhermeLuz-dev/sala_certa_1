    ...
    <div className={styles.container}>
      ...
      <div className={styles.mainContent}>
        <div className={styles.card}>
          ...
          <p className={styles.subtitulo}>Entre com suas credenciais abaixo.</p>
        ...
        <div
          className={styles.areaCalouro}
          onClick={() => navigate("/calouro")}
        >
          <span className={styles.textoCalouro}>É Calouro?</span>
          <span className={styles.linkCalouro}>Descubra sua sala</span>
        </div>
      </div>
